...
import { AcademicCapIcon, BriefcaseIcon, BuildingOfficeIcon, CurrencyDollarIcon, LinkIcon, ListBulletIcon, NewspaperIcon, TagIcon } from "@heroicons/react/24/solid";
...
const Page = () => {
    ...
    const [filteredData, seFilteredData] = useState(allJobs)
			...
			<div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-14">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tr>
						...
						<td scope="col" className="px-6 py-3 font-bold" style={{minWidth:"120px"}}>
                           Job Type
                        </td>
						<td scope="col" className="px-6 py-3 font-bold" style={{minWidth:"180px"}}>
