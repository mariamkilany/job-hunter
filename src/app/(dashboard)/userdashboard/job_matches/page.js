...
export default function JobMatch() {
  const employeeeApp = useSelector(
    (state) => state.applications.singleEmployeeApplication
  );
              ...
              <>
                ...
                <tr className="odd:bg-white even:bg-gray-50 ">
                  ...
                  <th>
                    <td
                      scope="row"
                      className="px-6 py-4 font-medium text-gray-900 flex items-center  dark:text-white"
                      style={{ minWidth: "280px" }}
                    >
                      <img
                        src={app.companyData?.image}
                        alt="logo app.companyData "
                        className=" inline rounded-full w-12 me-3"
                      ></img>
                  ...
                  <td className="px-6 py-4  w-fit">{app.jobData?.jobType}</td>
                  <td className="px-6 py-4  w-fit">{app.jobData?.place}</td>
                  <td className="px-6 py-4">{app.jobData?.salary} L.E</td>
                        ...
                        <div className="p-4 md:p-10 space-y-4 md:pt-4 relative">
                          ...
                          <div className=" space-y-4 ps-8">
                            ...
                            <p>
                              ...
                              Skills:{" "}
                              {app.jobData?.skills.map((skill, index) => {
                                return <span key={index}> {skill} ,</span>;
                              })}
                            </p>
                            <p>
                              <LinkIcon className="me-2 w-6 inline-block text-gray-400"></LinkIcon>
                              <a
                                className="text-primary"
                                href={app?.companyData?.links.linkedIn}
                                target="_blank"
                              >
                            ...
                            <ul className="list-disc text-gray-600 ps-12">
                              {app.jobData?.info.responsibilities
                                .split(",")
                                .map((resp, index) => {
