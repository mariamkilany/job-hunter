  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div>
          <img src="https://thumbs.dreamstime.com/b/cute-little-boy-feel-sad-get-bad-grade-exam-227190004.jpg"></img>
        </div>

        <div className="max-w-lg border border-1 border-gray-400 rounded-2xl  py-6 px-12 w-full space-y-8">
          <h2 className="  text-lg  font-bold  text-primary ">
            Sorry for not passing all recruitement process , wish you all the
            best
          </h2>

          <h2 className="mt-2 text-lg font-medium ">Feedback Message</h2>
