...
const Admin = () => {
 useEffect(()=>{
  ...
  if(document.getElementById("column-chart") && typeof ApexCharts !== 'undefined') {
    cloumnChart = new ApexCharts(document.getElementById("column-chart"), options);
    cloumnChart.render();
  }
          ...
          <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-6'> 
              <div className=' p-8 border border-1 rounded shadow-xl bg-primary  ' > 
                 ...
                 <h3 className='font-bold text-white text-3xl me-6 '>
                  ...
                  <span className=' font-medium text-white text-2xl '> No. of  Companies</span>
                 </div>
              </div>

              <div className=' p-8 border border-1 rounded shadow-xl ' style={{backgroundColor:"#56CDAD"}} > 
                 <div className='flex items-center justify-center'>
                 <h3 className='font-bold text-white text-3xl me-6 '>
                    123 
                  </h3>
                  <span className=' font-medium text-white text-2xl ' > No. of  Jobs</span>
                 </div>
              </div>

              <div className=' p-8 border border-1 rounded shadow-xl ' style={{backgroundColor:"#26A4FF"}} > 
                 <div className='flex items-center justify-center'>
                 <h3 className='font-bold text-white text-3xl me-6 '>
                    123 
                  </h3>
                  <span className=' font-medium text-white text-2xl ' > No. of Job Seekers</span>
                 </div>
              </div>
          </div>
