  ...
  return (
    <section>
      <header className="bg-primary-light  pt-20 flex flex-col gap-3 p-20">
        <div className="  text-slate-300">Home/Companies/Nomed</div>
        <div className="flex flex-wrap gap-3 p-1 mt-6">
          ...
          <div className="flex flex-col gap-8 justify-end">
            <h2 className="text-5xl font-semibold text-slate-100">Stripe</h2>
            <div className="flex flex-wrap gap-8">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col text-gray-300">
                  <span>Founded</span>
                  <span className="font-semibold">July 31,2011</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <span className="p-1 bg-white rounded-3xl  w-8 h-8">
