      ...
      <div className="flex flex-col justify-between  leading-normal w-500">
        <form class="max-w-sm mx-auto p-4">
          ...
          <button
            type="submit"
            style={{ color: "white" }}
            class=" bg-green  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Submit
          </button>
        </form>
