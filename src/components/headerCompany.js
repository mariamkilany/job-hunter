            ...
            <div className="mt-2 flex items-center text-sm text-gray-500">
              ...
              >
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M24.5 20.5005C24.5 19.1192 23.3808 18 22.0005 18C20.6192 18 19.5 19.1192 19.5 20.5005C19.5 21.8808 20.6192 23 22.0005 23C23.3808 23 24.5 21.8808 24.5 20.5005Z"
                  stroke="#26A4FF"
                  stroke-width="2"
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M21.9995 31C20.801 31 14.5 25.8984 14.5 20.5633C14.5 16.3866 17.8571 13 21.9995 13C26.1419 13 29.5 16.3866 29.5 20.5633C29.5 25.8984 23.198 31 21.9995 31Z"
                  stroke="#26A4FF"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <div className="mt-2 flex items-center text-sm text-gray-500">
              ...
              >
                ...
                <rect
                  ...
                  stroke="#D6DDEB"
                />
                <g clip-path="url(#clip0_305_14202)">
                  <path
                    d="M13 31H31"
                    stroke="#26A4FF"
                    stroke-width="2"
